...
```{r}
colon_plot <- barplot(height=shannon_colon_mean$shannon, ylim=c(0,5.5), ylab="Shannon Diversity Index", col=colors[shannon_colon_mean$dx], names.arg=dx_convert[shannon_colon_mean$dx])
arrows(x0=colon_plot, x1=colon_plot, y0=shannon_colon_mean$shannon, y1=shannon_colon_se$shannon)
```
...
matrix_plot <- barplot(mean_matrix, beside=T, ylim=c(0.0,5.5), col=colors[rownames(mean_matrix)], ylab="Shannon Diversity Index")
x_positions <- as.vector(matrix_plot)
arrows(x0=x_positions, x1=x_positions, y0=shannon_dx_gender_mean$shannon, y1=shannon_dx_gender_mean$shannon+shannon_dx_gender_se$shannon, angle=90)
box()
```
