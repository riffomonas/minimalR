...
plot(ave_rarefy[,"2003650"]~numsampled, col=colors[metadata[metadata$sample=="2003650", "dx"]], type="l", xlab="Number of Sequences Sampled", ylab="Average Number of OTUs observed")
```
...
```{r}
points(ave_rarefy[,"2005650"]~numsampled, col=colors[metadata[metadata$sample=="2005650", "dx"]], type="l")
```

Can you add two or three more lines to the plot?

```{r}
points(ave_rarefy[,"2007660"]~numsampled, col=colors[metadata[metadata$sample=="2007660", "dx"]], type="l")
points(ave_rarefy[,"2009650"]~numsampled, col=colors[metadata[metadata$sample=="2009650", "dx"]], type="l")
points(ave_rarefy[,"2013660"]~numsampled, col=colors[metadata[metadata$sample=="2013660", "dx"]], type="l")
```
...
plot(ave_rarefy[,"2003650"]~numsampled, col=colors[metadata[metadata$sample=="2003650", "dx"]], type="l", xlab="Number of Sequences Sampled", ylab="Average Number of OTUs observed", xlim=c(0,50000), ylim=c(0,max(ave_rarefy, na.rm=T)))
points(ave_rarefy[,"2007660"]~numsampled, col=colors[metadata[metadata$sample=="2007660", "dx"]], type="l")
points(ave_rarefy[,"2009650"]~numsampled, col=colors[metadata[metadata$sample=="2009650", "dx"]], type="l")
points(ave_rarefy[,"2013660"]~numsampled, col=colors[metadata[metadata$sample=="2013660", "dx"]], type="l")
```
...
```
points(ave_rarefy[,sample_name]~numsampled, col=colors[metadata[metadata$sample==sample_name, "dx"]], type="l")
```
...
for(sample_name in colnames(ave_rarefy)[c(1, 4, 7)]){
	points(ave_rarefy[,sample_name]~numsampled, col=colors[metadata[metadata$sample==sample_name, "dx"]], type="l", lwd=3)
}
```
...
for(sample_name in colnames(ave_rarefy)[c(1, 4, 7)]){
	points(ave_rarefy[,sample_name]~numsampled, col=colors[metadata[metadata$sample==sample_name, "dx"]], type="l", lty=line_types[metadata[metadata$sample==sample_name, "dx"]],lwd=3)
}
```
...
legend(x=25000, y=200, legend=c("Normal", "Adenoma", "Cancer"), col=colors, lty=line_types, lwd=3)
```
