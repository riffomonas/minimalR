...
stripchart(shannon ~ dx_ordinal, data=meta_alpha, subset=Gender=='f', ylab="Shannon Diversity Index", ylim=c(0, 5.0), col=alpha(dx_color[levels(dx_ordinal)], 0.5), group.names=dx_convert[levels(dx_ordinal)], xlim=c(0.5,7.0), vertical=T, method="jitter", jitter=0.2, pch=19)

stripchart(shannon ~ dx_ordinal, data=meta_alpha, subset=Gender=='m', at=seq(from=4.5,to=6.5,by=1), col=alpha(dx_color[levels(dx_ordinal)], 0.5), group.names=dx_convert[levels(dx_ordinal)], vertical=T, method="jitter", jitter=0.2, pch=19, add=T)
...
segments(x0=c(1:3, c(4.5,5.5,6.5))-0.25,y0=shannon_dx_gender_median$shannon, x1=c(1:3, c(4.5,5.5,6.5))+0.25,y1=shannon_dx_gender_median$shannon)
```
...
segments(x0=c(1:3, c(4.5,5.5,6.5))-0.25,y0=shannon_dx_gender_median$shannon, x1=c(1:3, c(4.5,5.5,6.5))+0.25,y1=shannon_dx_gender_median$shannon, lwd=5)
```
...
segments(x0=c(1:3, c(4.5,5.5,6.5))-0.3,y0=shannon_dx_gender_median$shannon, x1=c(1:3, c(4.5,5.5,6.5))+0.25,y1=shannon_dx_gender_median$shannon, lwd=5)
```
</div>
...
stripchart(sobs ~ dx_ordinal, data=meta_alpha, subset=Gender=='f', ylab="Shannon Diversity Index", ylim=c(0, 400), col=alpha(dx_color[levels(dx_ordinal)], 0.5), group.names=dx_convert[levels(dx_ordinal)], xlim=c(0.5,7.0), vertical=T, method="jitter", jitter=0.2, pch=19)

stripchart(sobs ~ dx_ordinal, data=meta_alpha, subset=Gender=='m', at=seq(from=4.5,to=6.5,by=1), col=alpha(dx_color[levels(dx_ordinal)], 0.5), group.names=dx_convert[levels(dx_ordinal)], vertical=T, method="jitter", jitter=0.2, pch=19, add=T)

mtext(side=1, at=c(2,5.5), line=3, cex=1.5, text=c("Female", "Male"))

segments(x0=c(1:3, c(4.5,5.5,6.5))-0.25,y0=sobs_dx_gender_median$sobs, x1=c(1:3, c(4.5,5.5,6.5))+0.25,y1=sobs_dx_gender_median$sobs, lwd=5)
```
</div>
