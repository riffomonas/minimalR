...
```{r}
dx_colors <- c(normal="black", adenoma="blue", carcinoma="red")
plot(meta_alpha$Age, meta_alpha$shannon, xlim=c(0,90), ylim=c(0,5), xlab="Age (years)",
		 ylab="Shannon Diversity Index", col=dx_colors[meta_alpha$dx], pch=19)
```
...
plot(shannon~Age, data=meta_alpha, xlim=c(0,90), ylim=c(0,5), xlab="Age (years)",
		 ylab="Shannon Diversity Index", col=dx_colors[dx], pch=19)
```
...
```{r}
sex_colors <- c(m="red", f="blue")
sex_symbol <- c(17, 19)
plot(sobs~fit_result, data=meta_alpha, xlim=c(0,3000), ylim=c(0, 400), xlab="Fit Result",
		 ylab="Number of OTUs", col=sex_colors[Gender], pch=sex_symbol[Smoke+1])
```
...
plot(sobs~fit_result, data=meta_alpha, xlim=c(0,3000), ylim=c(0, 400), xlab="Fit Result", ylab="Number of OTUs", col=sex_colors[Gender], pch=smoke_symbol[Smoke+1])
legend(x=2000, y=100, legend=c('Female smoker','Male smoker', 'Female non-smoker', 'Male non-smoker'), pch=c(19,19,17,17), col=c("blue", "red","blue","red"), pt.cex=1.5, cex=0.8)
```
...
sex_color <- c(m="red", f="blue")
smoke_symbol <- c(17, 19)
plot(sobs~fit_result, data=meta_alpha, xlim=c(0,3000), ylim=c(0, 400), xlab="Fit Result", ylab="Number of OTUs", col=sex_color[Gender], pch=smoke_symbol[Smoke+1])
