...
<input type="button" class="hideshow">
<div markdown="1" style="display:none;">
The library command loads the following packages and versions from the `tidyverse` package (as of version `r sessionInfo()$otherPkgs$tidyverse$Version`)
```
...
x<-1:25
y<-rep(1, 25)
plot(c(1,25), c(0,2), type="n", main="Symbol Values", xlab="", ylab="", axes=F)
abline(v=x, col="gray")
points(x,y, shape=x, cex=2, bg='gray', col='black', lwd=c(rep(1,20), rep(3,5)))
